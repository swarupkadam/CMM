...
exports.VirtualNetworkGatewayConnectionsImpl = void 0;
...
class VirtualNetworkGatewayConnectionsImpl {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options);
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, virtualNetworkGatewayConnectionName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, virtualNetworkGatewayConnectionName, options) {
        const poller = await this.beginDelete(resourceGroupName, virtualNetworkGatewayConnectionName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginUpdateTags(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateTagsAndWait(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        const poller = await this.beginUpdateTags(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginSetSharedKey(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginSetSharedKeyAndWait(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        const poller = await this.beginSetSharedKey(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginResetSharedKey(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginResetSharedKeyAndWait(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        const poller = await this.beginResetSharedKey(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginStartPacketCapture(resourceGroupName, virtualNetworkGatewayConnectionName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStartPacketCaptureAndWait(resourceGroupName, virtualNetworkGatewayConnectionName, options) {
        const poller = await this.beginStartPacketCapture(resourceGroupName, virtualNetworkGatewayConnectionName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginStopPacketCapture(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStopPacketCaptureAndWait(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options) {
        const poller = await this.beginStopPacketCapture(resourceGroupName, virtualNetworkGatewayConnectionName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginGetIkeSas(resourceGroupName, virtualNetworkGatewayConnectionName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginGetIkeSasAndWait(resourceGroupName, virtualNetworkGatewayConnectionName, options) {
        const poller = await this.beginGetIkeSas(resourceGroupName, virtualNetworkGatewayConnectionName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginResetConnection(resourceGroupName, virtualNetworkGatewayConnectionName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginResetConnectionAndWait(resourceGroupName, virtualNetworkGatewayConnectionName, options) {
        const poller = await this.beginResetConnection(resourceGroupName, virtualNetworkGatewayConnectionName, options);
        return poller.pollUntilDone();
    }
    /**
     * ListNext
...
exports.VirtualNetworkGatewayConnectionsImpl = VirtualNetworkGatewayConnectionsImpl;

...
class VirtualNetworkGatewaysImpl {
    ...
    async *listConnectionsPagingPage(resourceGroupName, virtualNetworkGatewayName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
            result = await this._listConnections(resourceGroupName, virtualNetworkGatewayName, options);
            const page = result.value || [];
            continuationToken = result.nextLink;
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
        ...
        while (continuationToken) {
            result = await this._listConnectionsNext(resourceGroupName, virtualNetworkGatewayName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listConnectionsPagingAll(resourceGroupName, virtualNetworkGatewayName, options) {
        for await (const page of this.listConnectionsPagingPage(resourceGroupName, virtualNetworkGatewayName, options)) {
            yield* page;
        }
    }
    /**
     ...
     * @param options The options parameters.
     */
    listRadiusSecrets(resourceGroupName, virtualNetworkGatewayName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, virtualNetworkGatewayName, options }, listRadiusSecretsOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginGetResiliencyInformation(resourceGroupName, virtualNetworkGatewayName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginGetResiliencyInformationAndWait(resourceGroupName, virtualNetworkGatewayName, options) {
        const poller = await this.beginGetResiliencyInformation(resourceGroupName, virtualNetworkGatewayName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginGetRoutesInformation(resourceGroupName, virtualNetworkGatewayName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginGetRoutesInformationAndWait(resourceGroupName, virtualNetworkGatewayName, options) {
        const poller = await this.beginGetRoutesInformation(resourceGroupName, virtualNetworkGatewayName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginInvokePrepareMigration(resourceGroupName, virtualNetworkGatewayName, migrationParams, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginInvokePrepareMigrationAndWait(resourceGroupName, virtualNetworkGatewayName, migrationParams, options) {
        const poller = await this.beginInvokePrepareMigration(resourceGroupName, virtualNetworkGatewayName, migrationParams, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginInvokeExecuteMigration(resourceGroupName, virtualNetworkGatewayName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginInvokeExecuteMigrationAndWait(resourceGroupName, virtualNetworkGatewayName, options) {
        const poller = await this.beginInvokeExecuteMigration(resourceGroupName, virtualNetworkGatewayName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginInvokeCommitMigration(resourceGroupName, virtualNetworkGatewayName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginInvokeCommitMigrationAndWait(resourceGroupName, virtualNetworkGatewayName, options) {
        const poller = await this.beginInvokeCommitMigration(resourceGroupName, virtualNetworkGatewayName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginInvokeAbortMigration(resourceGroupName, virtualNetworkGatewayName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginInvokeAbortMigrationAndWait(resourceGroupName, virtualNetworkGatewayName, options) {
        const poller = await this.beginInvokeAbortMigration(resourceGroupName, virtualNetworkGatewayName, options);
        return poller.pollUntilDone();
    }
    /**
     * ListNext
...
const listRadiusSecretsOperationSpec = {
    ...
    responses: {
        200: {
            bodyMapper: Mappers.RadiusAuthServerListResult,
        },
        default: {
            bodyMapper: Mappers.CloudError,
        },
...
const getResiliencyInformationOperationSpec = {
...
const getRoutesInformationOperationSpec = {
...
const getFailoverAllTestDetailsOperationSpec = {
    ...
    queryParameters: [Parameters.apiVersion, Parameters.typeParam, Parameters.fetchLatest],
    urlParameters: [
        Parameters.$host,
        Parameters.resourceGroupName,
        Parameters.subscriptionId,
...
const getFailoverSingleTestDetailsOperationSpec = {
    ...
    queryParameters: [Parameters.apiVersion, Parameters.peeringLocation, Parameters.failoverTestId],
    urlParameters: [
        Parameters.$host,
        Parameters.resourceGroupName,
        Parameters.subscriptionId,
...
const invokePrepareMigrationOperationSpec = {
    ...
    responses: {
        200: {
            headersMapper: Mappers.VirtualNetworkGatewaysInvokePrepareMigrationHeaders,
        },
        201: {
            headersMapper: Mappers.VirtualNetworkGatewaysInvokePrepareMigrationHeaders,
        },
...
const invokeExecuteMigrationOperationSpec = {
    ...
    responses: {
        200: {
            headersMapper: Mappers.VirtualNetworkGatewaysInvokeExecuteMigrationHeaders,
        },
        201: {
            headersMapper: Mappers.VirtualNetworkGatewaysInvokeExecuteMigrationHeaders,
        },
...
const invokeCommitMigrationOperationSpec = {
...
const invokeAbortMigrationOperationSpec = {

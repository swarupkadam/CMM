...
exports.VirtualHubIpConfigurationImpl = void 0;
...
class VirtualHubIpConfigurationImpl {
    ...
    async *listPagingPage(resourceGroupName, virtualHubName, options, settings) {
        let result;
    ...
    async *listPagingAll(resourceGroupName, virtualHubName, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, virtualHubName, ipConfigName, parameters, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, virtualHubName, ipConfigName, parameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, virtualHubName, ipConfigName, parameters, options);
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, virtualHubName, ipConfigName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, virtualHubName, ipConfigName, options) {
        const poller = await this.beginDelete(resourceGroupName, virtualHubName, ipConfigName, options);
        return poller.pollUntilDone();
    }
    /**
     * Retrieves the details of all VirtualHubIpConfigurations.
...
exports.VirtualHubIpConfigurationImpl = VirtualHubIpConfigurationImpl;

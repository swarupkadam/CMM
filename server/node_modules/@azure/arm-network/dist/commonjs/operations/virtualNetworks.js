...
class VirtualNetworksImpl {
    ...
    async *listUsagePagingPage(resourceGroupName, virtualNetworkName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
        ...
        while (continuationToken) {
            result = await this._listUsageNext(resourceGroupName, virtualNetworkName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listUsagePagingAll(resourceGroupName, virtualNetworkName, options) {
        for await (const page of this.listUsagePagingPage(resourceGroupName, virtualNetworkName, options)) {
            yield* page;
        }
    }
    /**
    ...
    async *listDdosProtectionStatusPagingPage(resourceGroupName, virtualNetworkName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
            const poller = await this._listDdosProtectionStatus(resourceGroupName, virtualNetworkName, options);
        ...
        while (continuationToken) {
            result = await this._listDdosProtectionStatusNext(resourceGroupName, virtualNetworkName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listDdosProtectionStatusPagingAll(resourceGroupName, virtualNetworkName, options) {
        for await (const page of this.listDdosProtectionStatusPagingPage(resourceGroupName, virtualNetworkName, options)) {
            yield* page;
        }
    }
    /**

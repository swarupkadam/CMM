...
exports.GalleryScriptsImpl = void 0;
...
class GalleryScriptsImpl {
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, galleryName, galleryScriptName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, galleryName, galleryScriptName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, galleryName, galleryScriptName, galleryScript, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, galleryName, galleryScriptName, galleryScript, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, galleryName, galleryScriptName, galleryScript, options);
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, galleryName, galleryScriptName, galleryScript, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, galleryName, galleryScriptName, galleryScript, options) {
        const poller = await this.beginUpdate(resourceGroupName, galleryName, galleryScriptName, galleryScript, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, galleryName, galleryScriptName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, galleryName, galleryScriptName, options) {
        const poller = await this.beginDelete(resourceGroupName, galleryName, galleryScriptName, options);
        return poller.pollUntilDone();
    }
    /**
     * ListByGalleryNext
...
exports.GalleryScriptsImpl = GalleryScriptsImpl;

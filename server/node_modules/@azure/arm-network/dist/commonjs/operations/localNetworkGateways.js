...
exports.LocalNetworkGatewaysImpl = void 0;
...
class LocalNetworkGatewaysImpl {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, localNetworkGatewayName, parameters, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, localNetworkGatewayName, parameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, localNetworkGatewayName, parameters, options);
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, localNetworkGatewayName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, localNetworkGatewayName, options) {
        const poller = await this.beginDelete(resourceGroupName, localNetworkGatewayName, options);
        return poller.pollUntilDone();
    }
    /**
...
exports.LocalNetworkGatewaysImpl = LocalNetworkGatewaysImpl;

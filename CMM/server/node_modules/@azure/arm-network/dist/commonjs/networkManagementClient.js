...
class NetworkManagementClient extends coreClient.ServiceClient {
    ...
    constructor(credentials, subscriptionIdOrOptions, options) {
        ...
        this.applicationGatewayPrivateLinkResources = new index_js_1.ApplicationGatewayPrivateLinkResourcesImpl(this);
        ...
        this.applicationGatewayWafDynamicManifests = new index_js_1.ApplicationGatewayWafDynamicManifestsImpl(this);
        ...
        this.availableResourceGroupDelegations = new index_js_1.AvailableResourceGroupDelegationsImpl(this);
        ...
        this.expressRouteCircuitAuthorizations = new index_js_1.ExpressRouteCircuitAuthorizationsImpl(this);
        this.expressRouteCircuitPeerings = new index_js_1.ExpressRouteCircuitPeeringsImpl(this);
        this.expressRouteCircuitConnections = new index_js_1.ExpressRouteCircuitConnectionsImpl(this);
        this.peerExpressRouteCircuitConnections = new index_js_1.PeerExpressRouteCircuitConnectionsImpl(this);
        ...
        this.expressRouteCrossConnectionPeerings = new index_js_1.ExpressRouteCrossConnectionPeeringsImpl(this);
        ...
        this.expressRoutePortAuthorizations = new index_js_1.ExpressRoutePortAuthorizationsImpl(this);
        this.expressRouteProviderPortsLocation = new index_js_1.ExpressRouteProviderPortsLocationImpl(this);
        this.firewallPolicies = new index_js_1.FirewallPoliciesImpl(this);
        this.firewallPolicyRuleCollectionGroups = new index_js_1.FirewallPolicyRuleCollectionGroupsImpl(this);
        this.firewallPolicyIdpsSignatures = new index_js_1.FirewallPolicyIdpsSignaturesImpl(this);
        this.firewallPolicyIdpsSignaturesOverrides = new index_js_1.FirewallPolicyIdpsSignaturesOverridesImpl(this);
        ...
        this.firewallPolicyRuleCollectionGroupDrafts = new index_js_1.FirewallPolicyRuleCollectionGroupDraftsImpl(this);
        ...
        this.loadBalancerBackendAddressPools = new index_js_1.LoadBalancerBackendAddressPoolsImpl(this);
        this.loadBalancerFrontendIPConfigurations = new index_js_1.LoadBalancerFrontendIPConfigurationsImpl(this);
        this.inboundNatRules = new index_js_1.InboundNatRulesImpl(this);
        this.loadBalancerLoadBalancingRules = new index_js_1.LoadBalancerLoadBalancingRulesImpl(this);
        ...
        this.networkInterfaceIPConfigurations = new index_js_1.NetworkInterfaceIPConfigurationsImpl(this);
        this.networkInterfaceLoadBalancers = new index_js_1.NetworkInterfaceLoadBalancersImpl(this);
        this.networkInterfaceTapConfigurations = new index_js_1.NetworkInterfaceTapConfigurationsImpl(this);
        ...
        this.subscriptionNetworkManagerConnections = new index_js_1.SubscriptionNetworkManagerConnectionsImpl(this);
        ...
        this.networkManagerRoutingConfigurations = new index_js_1.NetworkManagerRoutingConfigurationsImpl(this);
        ...
        this.networkSecurityPerimeters = new index_js_1.NetworkSecurityPerimetersImpl(this);
        this.networkSecurityPerimeterProfiles = new index_js_1.NetworkSecurityPerimeterProfilesImpl(this);
        this.networkSecurityPerimeterAccessRules = new index_js_1.NetworkSecurityPerimeterAccessRulesImpl(this);
        this.networkSecurityPerimeterAssociations = new index_js_1.NetworkSecurityPerimeterAssociationsImpl(this);
        this.networkSecurityPerimeterAssociableResourceTypes =
            new index_js_1.NetworkSecurityPerimeterAssociableResourceTypesImpl(this);
        this.networkSecurityPerimeterLinks = new index_js_1.NetworkSecurityPerimeterLinksImpl(this);
        this.networkSecurityPerimeterLinkReferences = new index_js_1.NetworkSecurityPerimeterLinkReferencesImpl(this);
        this.networkSecurityPerimeterLoggingConfigurations =
            new index_js_1.NetworkSecurityPerimeterLoggingConfigurationsImpl(this);
        this.networkSecurityPerimeterOperationStatuses =
            new index_js_1.NetworkSecurityPerimeterOperationStatusesImpl(this);
        this.networkSecurityPerimeterServiceTags = new index_js_1.NetworkSecurityPerimeterServiceTagsImpl(this);
        ...
        this.serviceEndpointPolicyDefinitions = new index_js_1.ServiceEndpointPolicyDefinitionsImpl(this);
        this.serviceGateways = new index_js_1.ServiceGatewaysImpl(this);
        this.serviceTags = new index_js_1.ServiceTagsImpl(this);
        this.serviceTagInformationOperations = new index_js_1.ServiceTagInformationOperationsImpl(this);
        ...
        this.virtualNetworkAppliances = new index_js_1.VirtualNetworkAppliancesImpl(this);
        this.virtualNetworkGateways = new index_js_1.VirtualNetworkGatewaysImpl(this);
        this.virtualNetworkGatewayConnections = new index_js_1.VirtualNetworkGatewayConnectionsImpl(this);
        ...
        this.networkVirtualApplianceConnections = new index_js_1.NetworkVirtualApplianceConnectionsImpl(this);
        ...
        this.webApplicationFirewallPolicies = new index_js_1.WebApplicationFirewallPoliciesImpl(this);
    }
    /**
    ...
    async *putBastionShareableLinkPagingPage(resourceGroupName, bastionHostName, bslRequest, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
            const poller = await this._putBastionShareableLink(resourceGroupName, bastionHostName, bslRequest, options);
        ...
        while (continuationToken) {
            result = await this._putBastionShareableLinkNext(resourceGroupName, bastionHostName, bslRequest, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *putBastionShareableLinkPagingAll(resourceGroupName, bastionHostName, bslRequest, options) {
        for await (const page of this.putBastionShareableLinkPagingPage(resourceGroupName, bastionHostName, bslRequest, options)) {
            yield* page;
        }
    }
    /**
    ...
    async *getBastionShareableLinkPagingPage(resourceGroupName, bastionHostName, bslRequest, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
            result = await this._getBastionShareableLink(resourceGroupName, bastionHostName, bslRequest, options);
            const page = result.value || [];
            continuationToken = result.nextLink;
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
        ...
        while (continuationToken) {
            result = await this._getBastionShareableLinkNext(resourceGroupName, bastionHostName, bslRequest, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *getBastionShareableLinkPagingAll(resourceGroupName, bastionHostName, bslRequest, options) {
        for await (const page of this.getBastionShareableLinkPagingPage(resourceGroupName, bastionHostName, bslRequest, options)) {
            yield* page;
        }
    }
    /**
    ...
    async *getActiveSessionsPagingPage(resourceGroupName, bastionHostName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
            const poller = await this._getActiveSessions(resourceGroupName, bastionHostName, options);
            result = await poller.pollUntilDone();
            const page = result.value || [];
            continuationToken = result.nextLink;
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
        ...
        while (continuationToken) {
            result = await this._getActiveSessionsNext(resourceGroupName, bastionHostName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *getActiveSessionsPagingAll(resourceGroupName, bastionHostName, options) {
        for await (const page of this.getActiveSessionsPagingPage(resourceGroupName, bastionHostName, options)) {
            yield* page;
        }
    }
    /**
    ...
    async *disconnectActiveSessionsPagingPage(resourceGroupName, bastionHostName, sessionIds, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
            result = await this._disconnectActiveSessions(resourceGroupName, bastionHostName, sessionIds, options);
            const page = result.value || [];
            continuationToken = result.nextLink;
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
        ...
        while (continuationToken) {
            result = await this._disconnectActiveSessionsNext(resourceGroupName, bastionHostName, sessionIds, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *disconnectActiveSessionsPagingAll(resourceGroupName, bastionHostName, sessionIds, options) {
        for await (const page of this.disconnectActiveSessionsPagingPage(resourceGroupName, bastionHostName, sessionIds, options)) {
            yield* page;
        }
    }
    /**
...
const expressRouteProviderPortOperationSpec = {
    ...
    queryParameters: [Parameters.apiVersion],
    urlParameters: [Parameters.$host, Parameters.subscriptionId, Parameters.providerport],
    headerParameters: [Parameters.accept],
    serializer,
};

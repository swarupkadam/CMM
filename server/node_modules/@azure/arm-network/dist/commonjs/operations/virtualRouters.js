...
exports.VirtualRoutersImpl = void 0;
...
class VirtualRoutersImpl {
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, virtualRouterName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, virtualRouterName, options) {
        const poller = await this.beginDelete(resourceGroupName, virtualRouterName, options);
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, virtualRouterName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, virtualRouterName, parameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, virtualRouterName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
     * Lists all Virtual Routers in a resource group.
...
exports.VirtualRoutersImpl = VirtualRoutersImpl;

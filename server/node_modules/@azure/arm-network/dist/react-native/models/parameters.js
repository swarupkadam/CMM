...
export const azureFirewallName3 = {
    parameterPath: "azureFirewallName",
    mapper: {
        constraints: {
...
export const parameters11 = {
    parameterPath: "parameters",
    mapper: ReserveCloudServicePublicIpAddressRequestMapper,
};
export const publicIpAddressName1 = {
    parameterPath: "publicIpAddressName",
    mapper: {
        constraints: {
...
export const parameters12 = {
    parameterPath: "parameters",
    mapper: DisassociateCloudServicePublicIpRequestMapper,
};
...
export const loadBalancerName2 = {
    parameterPath: "loadBalancerName",
    mapper: {
        constraints: {
            Pattern: new RegExp("^[a-zA-Z0-9_.-]*$"),
...
export const networkSecurityPerimeterName = {
...
export const linkReferenceName = {
...
export const loggingConfigurationName = {
...
export const serviceGatewayName = {
...
export const parameters82 = {
    parameterPath: "parameters",
    mapper: ServiceGatewayMapper,
};
export const parameters83 = {
    parameterPath: "parameters",
    mapper: ServiceGatewayUpdateAddressLocationsRequestMapper,
};
export const parameters84 = {
    parameterPath: "parameters",
    mapper: ServiceGatewayUpdateServicesRequestMapper,
};
...
export const virtualNetworkApplianceName = {
...
export const parameters86 = {
    parameterPath: "parameters",
    mapper: VirtualNetworkApplianceMapper,
};
...
export const parameters93 = {
    parameterPath: "parameters",
    mapper: ConnectionSharedKeyMapper,
};
export const parameters94 = {
    parameterPath: "parameters",
    mapper: ConnectionResetSharedKeyMapper,
};
export const parameters95 = {
    parameterPath: "parameters",
...
export const parameters97 = {
    parameterPath: "parameters",
    mapper: VirtualRouterMapper,
};
export const parameters98 = {
    parameterPath: "parameters",
...
export const vpnServerConfigurationName1 = {
    parameterPath: "vpnServerConfigurationName",
    mapper: {
        constraints: {
            Pattern: new RegExp("^[A-Za-z0-9_]+"),

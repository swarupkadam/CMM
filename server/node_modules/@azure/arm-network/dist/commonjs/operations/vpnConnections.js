...
exports.VpnConnectionsImpl = void 0;
...
class VpnConnectionsImpl {
    ...
    async *listByVpnGatewayPagingPage(resourceGroupName, gatewayName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listByVpnGatewayNext(resourceGroupName, gatewayName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listByVpnGatewayPagingAll(resourceGroupName, gatewayName, options) {
        for await (const page of this.listByVpnGatewayPagingPage(resourceGroupName, gatewayName, options)) {
            yield* page;
        }
    }
    /**
...
exports.VpnConnectionsImpl = VpnConnectionsImpl;

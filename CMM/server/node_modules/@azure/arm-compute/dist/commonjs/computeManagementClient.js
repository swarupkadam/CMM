...
class ComputeManagementClient extends coreClient.ServiceClient {
    ...
    constructor(credentials, subscriptionId, options) {
        ...
        this.virtualMachineScaleSetRollingUpgrades = new index_js_1.VirtualMachineScaleSetRollingUpgradesImpl(this);
        this.virtualMachineScaleSetExtensions = new index_js_1.VirtualMachineScaleSetExtensionsImpl(this);
        this.virtualMachineScaleSetVMs = new index_js_1.VirtualMachineScaleSetVMsImpl(this);
        this.virtualMachineScaleSetVMExtensions = new index_js_1.VirtualMachineScaleSetVMExtensionsImpl(this);
        this.virtualMachineScaleSetVMRunCommands = new index_js_1.VirtualMachineScaleSetVMRunCommandsImpl(this);
        ...
        this.galleryInVMAccessControlProfiles = new index_js_1.GalleryInVMAccessControlProfilesImpl(this);
        this.galleryInVMAccessControlProfileVersions = new index_js_1.GalleryInVMAccessControlProfileVersionsImpl(this);
        this.galleryScripts = new index_js_1.GalleryScriptsImpl(this);
        this.galleryScriptVersions = new index_js_1.GalleryScriptVersionsImpl(this);

...
export class VirtualNetworkAppliancesImpl {
    client;
    /**
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, virtualNetworkApplianceName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, virtualNetworkApplianceName, options) {
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, virtualNetworkApplianceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, virtualNetworkApplianceName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, virtualNetworkApplianceName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, virtualNetworkApplianceName, parameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, virtualNetworkApplianceName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    updateTags(resourceGroupName, virtualNetworkApplianceName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, virtualNetworkApplianceName, parameters, options }, updateTagsOperationSpec);
    }
    /**
     * Gets all virtual network appliances in a subscription.
     * @param options The options parameters.
...
//# sourceMappingURL=virtualNetworkAppliances.js.map